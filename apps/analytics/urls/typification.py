...
from apps.analytics.views import TypificationMaintenanceAPIView
from apps.common.constants import API_ACTION_EXPORT_INDIVIDUAL

app_name = "typification"

urlpatterns = [
    path("", TypificationMaintenanceAPIView.as_view(), name=f"{API_ACTION_HOME}"),
    path(f"{API_ACTION_ADD}/", TypificationMaintenanceAPIView.as_view(), name=f"{API_ACTION_ADD}"),
    path(
        f"{API_ACTION_EDIT}/<int:object_pk>/",
        TypificationMaintenanceAPIView.as_view(),
    ...
    path(
        f"{API_ACTION_LIST}/", TypificationMaintenanceAPIView.as_view(), name=f"{API_ACTION_LIST}"
    ),
    path(
        f"{API_ACTION_IMPORT}/",
        TypificationMaintenanceAPIView.as_view(),
    ...
    path(
        ...
        include("apps.analytics.urls.typification_pattern", namespace="pattern"),
    ),
    path(
